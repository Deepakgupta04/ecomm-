    ...
    <header class="header" id="header">
      ...
      <div class="top-nav">
        <div class="container d-flex">
          <p>Order Online Or Call Us: 96541880xx</p>
          <ul class="d-flex">
      ...
      <div class="navigation">
        ...
        <a href="/" class="logo"><h1>H&M</h1></a>
          ...
          <ul class="nav-list d-flex">
            ...
            <li class="nav-item">
              <a href="https://www2.hm.com/en_in/index.html" class="nav-link">Shop</a>
            </li>
            <li class="nav-item">
...
<div class="left">
  <span class="trend">we are here</span>
  <h2>Big billions days 2022</h2>
  <p>New Arrival <span class="color">Sale 70% OFF</span> Limited Time Offer</p>
  <a href="#" class="btn btn-1">Shop Now</a>
</div>
<div class="right">
      ...
      <div class="product-center">
        <div class="product-item">
          ...
          <div class="product-info">
            ...
            <a href="productDetails.html">Raw pink</a>
            <h4>900</h4>
          </div>
          <ul class="icons">
    ...
    <section class="section new-arrival">
      ...
      <div class="product-center">
        ...
        <div class="product-item">
          ...
          <div class="product-info">
            <span>MEN'S CLOTHES</span>
            <a href="">Concepts Solid Men’s Polo</a>
            <h4>1050</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
